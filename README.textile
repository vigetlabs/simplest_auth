...
"!https://codeclimate.com/github/vigetlabs/simplest_auth.png!":https://codeclimate.com/github/vigetlabs/simplest_auth "!https://travis-ci.org/vigetlabs/simplest_auth.png!":https://travis-ci.org/vigetlabs/simplest_auth
...
Simplest Auth uses the I18n API to lookup user messages. To customize your messages you can create override these values in a locale file like this:

<pre><code>
en:
  simplest_auth:
    login_message: Login or Registration Required
    session:
      create: You have signed in successfully
      destroy: You have signed out
      auth_error: "%{user_class} not found for supplied credentials"
</code></pre>
